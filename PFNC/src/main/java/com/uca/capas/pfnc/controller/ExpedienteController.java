...
public class ExpedienteController {
	...
	public ModelAndView nuevoExpedienteSave(@Valid @ModelAttribute Alumno alumno,BindingResult result,@RequestParam Integer centro_id) {
		
		
		ModelAndView mav = new ModelAndView();
		CentroEscolar centroEscolar = centroEscolarService.findOne(centro_id);
	...
	//Filtrar centros escolares por municipio
	   @RequestMapping( value="/getCentrosbyMunicipio",method= RequestMethod.GET)
	    public @ResponseBody List<CentroEscolarDTO> getClientesFechaEstado(
	            @RequestParam Integer municipioId) throws ParseException {
